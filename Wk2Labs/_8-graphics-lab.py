...
ax.set_title('MPG by engine displacement')
# Compute the average mpg, and add a black dotted horizontal
# line to show this value
plt.axhline(y=df['mpg'].mean(), label='average mpg', color = 'black', linestyle = 'dotted')
...
plt.bar(cyl_counts.keys(),cyl_counts)
...
sns.barplot(x=cyl_counts.keys(), y=cyl_counts)
